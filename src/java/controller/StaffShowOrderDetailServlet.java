 ...
 * @author ASUS
 */
@WebServlet(name = "StaffShowOrderDetailServlet", urlPatterns = {"/StaffShowOrderDetailServlet"})
public class StaffShowOrderDetailServlet extends HttpServlet {
        ...
        try {
            if (session != null) {
                ...
                if (accountDTO != null) {
                    ...
                    url = Constant.Page.STAFF_ORDER_DETAIL_PAGE;
                } 
            } 
        } catch (Exception e) {
