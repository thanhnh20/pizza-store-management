 ...
 * @author ASUS
 */
@WebServlet(name = "StaffShowUsersServlet", urlPatterns = {"/StaffShowUsersServlet"})
public class StaffShowUsersServlet extends HttpServlet {
        ...
        try {
            if (session != null) {
                ...
                if (accountDTO != null) {
                    ...
                    List<CustomerDTO> listuser = customerDAO.getAllUser();
