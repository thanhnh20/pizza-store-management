...
public class StartUpServlet extends HttpServlet {
    private final String HOME_PAGE_CONTROLLER = "HomePageServlet";
    private final String SHOW_LIST_PRODUCT_TO_STAFF_CONTROLLER = "ShowAllProductServlet";
    /**
            ...
            if(listCookie != null){
                ...
                if(result){
                    ...
                    if (accountDTO.getRole() == 1) {
                        ...
                        url = SHOW_LIST_PRODUCT_TO_STAFF_CONTROLLER;
                    } else {
                        HttpSession session = request.getSession();
