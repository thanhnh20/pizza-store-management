 ...
 * @author ASUS
 */
@WebServlet(name = "StaffShowOrdersServlet", urlPatterns = {"/StaffShowOrdersServlet"})
public class StaffShowOrdersServlet extends HttpServlet {
        ...
        try {
            if (session != null) {
                ...
                if (accountDTO != null) {
                    ...
                    List<OrderDTO> list = dao.getAllOrder();
                    if (!list.isEmpty()) {
