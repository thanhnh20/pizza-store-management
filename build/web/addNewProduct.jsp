           ...
           <c:set var="error" value="${requestScope.PRODUCT_ERROR}"/>
            ...
            <form class="form" action="DispatchController">
                <div class="form-floating">
                    <input required type="text" name="txtProductName" value="${param.txtProductName}" class="form-control" id="formInputName" placeholder="input">
                    <label for="formInputBookID">*Product name</label>
                </div>
                ...
                <div class="form-floating">
                    <input required type="text" name="txtDescription" value="${param.txtDescription}" class="form-control" id="formInputName" placeholder="input">
                    <label for="formInputName">*Description</label>
                </div>
                <div class="error text-danger text-left">
                    <c:if test="${not empty error}">
                ...
                <div class="form-floating">
                    <select name="category" class="form-control btn" aria-label="Default select example">
                        <option value="1">
                            Standard
                        </option>
                ...
                <button class="btn btn-outline-primary" type="submit" value="CreateProduct" name="btnAction">
                    Create
                </button>
